...
- Keep `edit_slide_xml` scoped to serialized OOXML/package operations and keep `edit_slide_master` scoped to native layout/master resolution; do not claim unsupported slideshow-frame/runtime behavior.
