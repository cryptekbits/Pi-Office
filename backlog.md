...
- [ ] IMPROVEMENT-009: Continue splitting large Office action executors by feature domain
  ...
  - Subtasks:
    ...
    - [ ] Split PowerPoint slide-structure handlers into `powerpoint-actions/` modules.
