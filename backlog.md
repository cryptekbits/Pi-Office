...
- [ ] IMPROVEMENT-009: Continue splitting large Office action executors by feature domain
  ...
  - Subtasks:
    ...
    - [ ] Split PowerPoint OOXML/package handlers into `powerpoint-actions/` modules.
    - [ ] Split PowerPoint chart/notes handlers into `powerpoint-actions/` modules.
