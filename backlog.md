...
- [ ] FEATURE-032: Add Word-native LaTeX and OfficeMath equation insertion
  ...
  - Subtasks:
    ...
    - [ ] Add MathML input or a fuller audited conversion pipeline if Pi-Office needs equation coverage beyond the first-party LaTeX subset.
