...
Do not claim a page break landed, a document has two pages, or a page count is correct from word_section_layout success alone. Claim page-break or page-count success only after verify_doc, verify_doc_visual, or native page metadata evidence confirms it.
