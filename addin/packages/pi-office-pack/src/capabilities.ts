...
export const PI_OFFICE_CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  {
    ...
    owner: "addin-only",
    tools: ["office_get_context", "office_tool_search", "office_tool_get", "office_read_section", "verify_doc", "get_cell_ranges", "get_all_objects", "search_data", "get_presentation_structure", "get_slide", "list_slide_shapes", "verify_slides"],
