...
export const PI_OFFICE_CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  {
    ...
    owner: "addin-only",
    tools: ["office_get_context", "office_tool_search", "office_tool_get", "word_search", "office_read_section", "verify_doc", "get_cell_ranges", "get_all_objects", "search_data", "get_presentation_structure", "get_slide", "list_slide_shapes", "verify_slides"],
  ...
  },
  {
    ...
    owner: "addin-only",
    tools: ["office_tool_call", "office_batch_execute", "office_apply_edit", "edit_doc_text", "word_format_text", "word_list_format", "word_reference_inventory", "word_hyperlink", "word_table", "word_section_layout", "word_equation", "word_field_reference", "word_content_control", "word_building_block", "word_annotation_review", "word_redline_review", "set_cell_range", "clear_cell_range", "resize_range", "copy_to", "modify_sheet_structure", "modify_object", "office_navigate", "modify_presentation_structure", "duplicate_slide", "insert_slide_element", "remove_slide_element", "edit_slide_text", "edit_slide_xml", "edit_slide_master", "edit_slide_chart", "copy_image_between_slides", "insert_icon", "office_execute_js"],
    requiresCompanion: false,
    requiresSavedDocument: false,
