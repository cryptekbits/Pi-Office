...
export const POWERPOINT_OFFICE_TOOL_DEFINITIONS: readonly OfficeToolDefinition[] = [
  ...
  },
  {
    ...
    riskLevel: "medium",
    keywords: ["powerpoint", "insert", "shape", "text box", "image", "table", "element", "component"],
    label: "Insert Slide Element",
    description: "PowerPoint-only first-class element insertion tool for explicit shape/table/diagram/picture/component authoring through native actions.",
    parameters: Type.Object({
      operation: Type.String({ description: "PowerPoint element insertion operation (add_text_box, add_geometric_shape, add_table, add_line, add_process_flow, add_simple_diagram, insert_inline_picture, add_reusable_component)." }),
