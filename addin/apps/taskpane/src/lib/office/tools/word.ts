...
export const WORD_OFFICE_TOOL_DEFINITIONS: readonly OfficeToolDefinition[] = [
  ...
  },
  {
    ...
    label: "Word Equation",
    description:
      "Word-only native OfficeMath equation insertion from LaTeX. Use this instead of insertHtml for formulas, equations, and research-paper math.",
    discovery: {
      tier: "specialized",
      capabilityIds: ["word.equations", "word.officemath"],
      keywords: ["word", "equation", "formula", "latex", "math", "omml", "officemath"],
      summary: "Convert LaTeX math into persisted Word OfficeMath OOXML and verify m:oMath evidence.",
      riskLevel: "medium",
      requirementSets: [{ name: "WordApi", minVersion: "1.1" }],
      fallback: "If native OfficeMath insertion fails, explain the limitation; do not insert raw LaTeX and claim it rendered.",
    },
    parameters: Type.Object({
      latex: Type.String({ description: "LaTeX math only. Delimiters like $$...$$, \\[...\\], or \\(...\\) are accepted but not required." }),
